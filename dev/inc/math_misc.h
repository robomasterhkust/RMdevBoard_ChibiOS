...
/**
 * @source matlab function tf2sos
 *
 * Convert digital filter transfer function data to second-order sections form
 *
 * for 4th order butterworth filter
 */
typedef struct
{
    int order;
    lpfilterStruct* filter1;
    lpfilterStruct* filter2;
    float gain;
} sosfilterStruct;


/**
 * @source CMSIS arm_math.h
 *
 ...
 */
static inline float arm_pid_f32(
...
void lpfilter_init_direct(lpfilterStruct* const lp,
