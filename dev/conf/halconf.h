...
#define PN1_ON()        (palSetPad(GPIOD, GPIOD_PIN14_TIM4_CH3))
#define PN2_ON()        (palSetPad(GPIOD, GPIOD_PIN15_TIM4_CH4))
#define PN3_ON()        (palSetPad(GPIOH, GPIOH_PIN10_TIM5_CH1))
#define PN4_ON()        (palSetPad(GPIOH, GPIOH_PIN11_TIM5_CH2))
#define PN5_ON()        (palSetPad(GPIOH, GPIOH_PIN12_TIM5_CH3))
#define PN6_ON()        (palSetPad(GPIOI, GPIOI_PIN0_TIM5_CH4))
#define PN1_OFF()       (palClearPad(GPIOD, GPIOD_PIN14_TIM4_CH3))
#define PN2_OFF()       (palClearPad(GPIOD, GPIOD_PIN15_TIM4_CH4))
#define PN3_OFF()       (palClearPad(GPIOH, GPIOH_PIN10_TIM5_CH1))
#define PN4_OFF()       (palClearPad(GPIOH, GPIOH_PIN11_TIM5_CH2))
#define PN5_OFF()       (palClearPad(GPIOH, GPIOH_PIN12_TIM5_CH3))
#define PN6_OFF()       (palClearPad(GPIOI, GPIOI_PIN0_TIM5_CH4))
#define PN1_TOGGLE()    (palTogglePad(GPIOD, GPIOD_PIN14_TIM4_CH3))
#define PN2_TOGGLE()    (palTogglePad(GPIOD, GPIOD_PIN15_TIM4_CH4))
#define PN3_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN10_TIM5_CH1))
#define PN4_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN11_TIM5_CH2))
#define PN5_TOGGLE()    (palTogglePad(GPIOH, GPIOH_PIN12_TIM5_CH3))
#define PN6_TOGGLE()    (palTogglePad(GPIOI, GPIOI_PIN0_TIM5_CH4))
